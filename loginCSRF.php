...
<div class="container">
    <form id='login' action="loginCSRF.php" method='post' accept-charset='UTF-8'>
...
if(!empty($userName) and !empty($password)) {
    ...
    if (! empty($loginInUser)) {
       ...
       // $_SESSION["userName"] = $loginInUser;
        ...
        echo "</br></br><a class=\"btn btn-success\" href='myActivitiesCSRF.php?userName=" .$loginInUser ."'> My Activities</a>";
         echo "</div>";
